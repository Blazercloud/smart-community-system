...
public class ParkingApplicationServiceImpl extends ServiceImpl<ParkingApplicationMapper, ParkingApplication>
     ...
     */
    @Override
    public Result<PageResult<ParkingApplicationVO>> getAllParkingApplication(Integer currentPage,Integer pageSize,String status) {
        ...
        PageResult<ParkingApplicationVO> pageResult = new PageResult<>();
